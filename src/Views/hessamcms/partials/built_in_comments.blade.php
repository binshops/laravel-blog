@forelse($comments as $comment)
    ...
    <div class="card bg-light mb-3">
        <div class="card-header">
            ...
            @if(config("hessamcms.comments.ask_for_author_website") && $comment->author_website)
...
@if(count($comments)> config("hessamcms.comments.max_num_of_comments_to_show",500) - 1)
    <p><em>Only the first {{config("hessamcms.comments.max_num_of_comments_to_show",500)}} comments are
            shown.</em>
    </p>
@endif
