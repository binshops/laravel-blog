...
@section("content")
    ...
    @forelse ($categories as $category)
        ...
        <div class="card m-4">
            <div class="card-body">
                <h5 class='card-title'><a class="a-link-cart-color" href='{{$category->url($language_id)}}'>{{$category->categoryTranslations()->where('lang_id', $language_id)->first()->category_name}}</a></h5>
