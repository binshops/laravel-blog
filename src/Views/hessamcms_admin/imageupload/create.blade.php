...
@section("content")
    ...
    <form method='post' action='{{route("hessamcms.admin.images.store")}}' enctype="multipart/form-data">
        ...
        <div class="form-group mb-4 p-2">
            ...
            <div>
                <input type='checkbox' name='sizes_to_upload[hessamcms_full_size]' value='true' checked id='size_hessamcms_full_size'>
            <label for='size_hessamcms_full_size'>Full size (no resizing)</label>
                </div>
