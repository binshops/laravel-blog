...
@section("content")
    ...
    <form id="edit-post-form" method='post' action='{{route("hessamcms.admin.update_post",$post->id)}}'  enctype="multipart/form-data" >
        ...
        @csrf
        @method("patch")
        @include("hessamcms_admin::posts.form", [
          'post' => $post,
    ...
    <script>
        //multi language
        var edit_toggle_url = '{{route("hessamcms.admin.edit_post_toggle",$post->id)}}';
