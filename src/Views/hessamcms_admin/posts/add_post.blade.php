...
@section("content")
    ...
    <form id="add-post-form" method='post' action='{{route("hessamcms.admin.store_post")}}'  enctype="multipart/form-data" >
    ...
    <script>
        //multi language
        var store_toggle_url = '{{route("hessamcms.admin.store_post_toggle")}}';
