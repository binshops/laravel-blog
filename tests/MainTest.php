...
//        $new_object_vals['use_view_file'] = "";
        ...
        $justCreatedRow = \WebDevEtc\BlogEtc\Models\HessamPost::where("slug", $new_object_vals['slug'])->firstOrFail();
...
//        $new_object_vals['use_view_file'] = "";
    ...
    public function testCreatePostThenSetCommentsToDisabledAndCheckNoneShow()
    {
        ...
        $newblogpost = new \WebDevEtc\BlogEtc\Models\HessamPost;
...
//        $new_object_vals['use_view_file'] = "";
        ...
        $justAddedRow = \WebDevEtc\BlogEtc\Models\HessamComment::withoutGlobalScopes()->where('author_name', $comment_detail['author_name'])->firstOrFail();
...
//        $new_object_vals['use_view_file'] = "";
    ...
    public function testCanCreateCategoryThenEditIt()
    {
        ...
        $justCreatedRow = \WebDevEtc\BlogEtc\Models\HessamCategory::where("slug", $new_cat_vals['slug'])->firstOrFail();
